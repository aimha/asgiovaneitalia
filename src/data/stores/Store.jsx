...
function createStateManagement() {
  const [state] = createStore({
    ...
    membership: {
      ...
      subtitle:
        'Diventa socio ed entra in una comunità che da quasi cento anni coltiva sport, cultura e passione.',
      body: [
    ...
    gallery: [
      {
        ...
        url: '',
        thumbnail_url:
          'https://images.unsplash.com/photo-1535506197904-e5c09c0e5619?q=80&w=1740&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
      },
      {
        title: 'My Awesome Photo',
        description: 'This is an avarage description',
